					...
					[
						...
						_List_fromArray(
							[
								...
								_List_fromArray(
									[
										elm$html$Html$Attributes$class('tite')
									]),
								_List_fromArray(
									[
...
_Platform_export({'Main':{'init':author$project$Main$main(
	elm$json$Json$Decode$succeed(_Utils_Tuple0))({"versions":{"elm":"0.19.0"},"types":{"message":"Main.Msg","aliases":{"Main.Game":{"args":[],"type":"{ id : Basics.Int, date : String.String, questions : List.List Main.Question }"},"Main.Question":{"args":[],"type":"{ question : String.String, correct_answer : String.String, answers : List.List String.String, image_url : String.String, image_author : String.String, image_author_profile : String.String }"}},"unions":{"Main.Msg":{"args":[],"tags":{"NextQuestion":["Main.Game"]}},"Basics.Int":{"args":[],"tags":{"Int":[]}},"List.List":{"args":["a"],"tags":{}},"String.String":{"args":[],"tags":{"String":[]}}}}})}});}(this));