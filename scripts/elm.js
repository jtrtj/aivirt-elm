...
var author$project$Main$NextQuestion = function (a) {
	return {$: 'NextQuestion', a: a};
};
...
var author$project$Main$gameQuestions = function (game) {
	return elm$core$Dict$fromList(
		A2(elm$core$List$indexedMap, elm$core$Tuple$pair, game.questions));
};
...
var author$project$Main$gameStart = A2(
...
var author$project$Main$answerButton = function (answer) {
	return A2(
		elm$html$Html$tr,
		_List_Nil,
		_List_fromArray(
...
var author$project$Main$getQuestion = F2(
	function (questions, index) {
		var _n0 = A2(elm$core$Dict$get, index, questions);
		if (_n0.$ === 'Just') {
			var question = _n0.a;
			return author$project$Main$questionHero(question);
		} else {
			return author$project$Main$gameStart;
		}
	});
		...
		_List_fromArray(
			[
				...
				_List_fromArray(
					[
						A2(
						author$project$Main$getQuestion,
						author$project$Main$gameQuestions(model),
					...
					[
						...
						_List_fromArray(
							[
								...
								author$project$Main$NextQuestion(model))
							]),
						_List_fromArray(
							[
