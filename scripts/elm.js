...
var author$project$Main$checkAnswer = F2(
	function (model, guess) {
		return _Utils_eq(
			guess,
			author$project$Main$getCurrentQuestion(model).correct_answer) ? _Utils_update(
			model,
			{
				...
				results: _Utils_ap(
					...
					_List_fromArray(
						[
							...
							true,
							author$project$Main$getCurrentQuestion(model))
						]))
			}) : _Utils_update(
			model,
			{
...
var author$project$Main$gamePlay = function (model) {
...
var author$project$Main$update = F2(
	function (msg, model) {
		if (msg.$ === 'GamePlay') {
			return author$project$Main$gamePlay(model);
		} else {
			var guess = msg.a;
			return A2(author$project$Main$checkAnswer, model, guess);
		}
	});
var author$project$Main$resultSymbol = function (result) {
	return result ? '✔️' : '❌';
};
...
var author$project$Main$resultRow = function (result) {
	return A2(
		elm$html$Html$tr,
		_List_Nil,
		_List_fromArray(
			[
				...
				_List_fromArray(
					[
						elm$html$Html$text(result.question.question)
					])),
				A2(
				elm$html$Html$td,
				_List_Nil,
				_List_fromArray(
					[
						elm$html$Html$text(
						author$project$Main$resultSymbol(result.correct))
					])),
				A2(
				elm$html$Html$td,
				_List_Nil,
				_List_fromArray(
					[
						elm$html$Html$text(result.question.correct_answer)
					]))
			]));
};
...
var author$project$Main$resultTable = function (game) {
	return A2(
		elm$html$Html$table,
		_List_Nil,
		_List_fromArray(
			[
				...
				elm$html$Html$tbody,
				_List_Nil,
				A2(elm$core$List$map, author$project$Main$resultRow, game.results))
			]));
};
...
var author$project$Main$gameEnd = function (game) {
	return A2(
		elm$html$Html$section,
		_List_fromArray(
			[
				elm$html$Html$Attributes$class('hero is-dark is-fullheight')
			]),
		_List_fromArray(
			[
				A2(
													...
													[
														...
														_List_fromArray(
															[
																...
																_List_fromArray(
																	[
																		author$project$Main$resultTable(game)
																	]))
															]))
													]))
											]))
...
var author$project$Main$GamePlay = {$: 'GamePlay'};
...
var author$project$Main$gameStart = function (game) {
	return A2(
		elm$html$Html$section,
		_List_fromArray(
			[
					...
					[
						...
						_List_fromArray(
							[
								...
								_List_fromArray(
									[
										elm$html$Html$text('Welcome to Aivirt')
									])),
								A2(
								elm$html$Html$h2,
								_List_fromArray(
								...
								_List_fromArray(
									[
										...
										_List_fromArray(
											[
												elm$html$Html$Attributes$class('button is-danger is-inverted is-outlined'),
												elm$html$Html$Events$onClick(author$project$Main$GamePlay)
											]),
										_List_fromArray(
											[
												elm$html$Html$text('Play today\'s game')
											]))
									]))
							]))
					]))
...
var author$project$Main$answerButton = function (guess) {
	return A2(
		elm$html$Html$tr,
		_List_Nil,
		_List_fromArray(
					...
					[
						...
						_List_fromArray(
							[
								...
								author$project$Main$Answer(guess))
							]),
						_List_fromArray(
							[
...
var author$project$Main$answerButtons = function (question) {
	return A2(elm$core$List$map, author$project$Main$answerButton, question.answers);
};
var elm$virtual_dom$VirtualDom$style = _VirtualDom_style;
var elm$html$Html$Attributes$style = elm$virtual_dom$VirtualDom$style;
var author$project$Main$heroStyle = function (question) {
	return _List_fromArray(
		[
			elm$html$Html$Attributes$class('hero is-fullheight'),
			A2(elm$html$Html$Attributes$style, 'background-image', 'url(' + (question.image_url + ')')),
...
var author$project$Main$questionHero = function (question) {
	return A2(
		elm$html$Html$section,
		author$project$Main$heroStyle(question),
		_List_fromArray(
			[
				A2(
				elm$html$Html$div,
													...
													[
														...
														_List_fromArray(
															[
																...
																_List_fromArray(
																	[
																		elm$html$Html$text(question.question)
																	])),
																A2(
																elm$html$Html$nav,
																_List_fromArray(
				...
				_List_fromArray(
					[
						...
						_List_fromArray(
							[
								elm$html$Html$Attributes$class('tabs is-boxed is-fullwidth')
							]),
						_List_fromArray(
							[
								A2(
											...
											[
												...
												_List_fromArray(
													[
														...
														_List_fromArray(
															[
																elm$html$Html$Attributes$href(question.image_author_profile),
																elm$html$Html$Attributes$target('blank')
															]),
														_List_fromArray(
															[
																elm$html$Html$text('Image by:' + question.image_author)
															])),
														A2(
														elm$html$Html$li,
														_List_Nil,
														_List_fromArray(
															[
																...
																_List_fromArray(
																	[
																		elm$html$Html$Attributes$href('https://unsplash.com/developers'),
																		elm$html$Html$Attributes$target('blank')
																	]),
																_List_fromArray(
																	[
																		elm$html$Html$text('Provided by: Unsplash')
																	]))
															]))
													]))
											]))
...
var author$project$Main$getQuestion = function (game) {
	...
	if (_n0.$ === 'Just') {
		var question = _n0.a;
		return author$project$Main$questionHero(question);
	} else {
		return A2(
			elm$html$Html$div,
			_List_Nil,
			_List_fromArray(
				[
					elm$html$Html$text('There has been an error.')
				]));
	}
};
...
_Platform_export({'Main':{'init':author$project$Main$main(
	elm$json$Json$Decode$succeed(_Utils_Tuple0))({"versions":{"elm":"0.19.0"},"types":{"message":"Main.Msg","aliases":{},"unions":{"Main.Msg":{"args":[],"tags":{"GamePlay":[],"Answer":["String.String"]}},"String.String":{"args":[],"tags":{"String":[]}}}}})}});}(this));